...
namespace SwitcheoTrader.NetCore.Business.Interfaces
{
    public interface ITradeBuilder
    {
        ...
        Candlstick[] GetCandlesticks(string symbol, Interval interval, int range);
        ...
        Order PlaceTrade(TradeParams tradeParams);
        ...
        bool CheckTradeStatus(Order trade);
        ...
        /// <returns>TradeResponse object</returns>
        Order MakeTrade(Side side, decimal orderPrice);
        ...
        /// <returns>TradeResponse object</returns>
        Order PlaceStopLoss(decimal orderPrice, decimal quantity);
